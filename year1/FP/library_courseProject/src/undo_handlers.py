...
def remove_client_handler(client_service, client_id, client_name):
    client_service.add_new_client(client_id,client_name)

def update_book_information_handler(book_service, book_id, new_book_title, old_book_title,new_book_author, old_book_author):
...
def rent_book_handler(rental_service,author, rental_id,book_id, client_id, rental_day,rental_month,rental_year):
    rental_service.undo_rental(author,book_id )

def return_book_handler(rental_service,rental_id, return_day,return_month, return_year):
    rental_service.undo_return(rental_id)
